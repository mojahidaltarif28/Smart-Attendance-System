...
class Face_Recognition_System:
    def __init__(self,root):
        ...
        img=Image.open(r"college_images\1.jpg")
        ...
        img2=Image.open(r"college_images\abcd.jpg")
    ...
    #Train btn
        ...
        b4_1=Button(bg_img,text="Train Data",command=self.train_data,cursor="hand2",font=("times new roman",12,"bold"),bg="#222222",fg="#00c3e3")
        b4_1.place(x=800,y=240,width=150,height=35)
    #Photos btn
        img8=Image.open(r"college_images\Photos.jpg")
        ...
        b5_1=Button(bg_img,text="Photos",cursor="hand2",command=self.open_img,font=("times new roman",12,"bold"),bg="#222222",fg="#00c3e3")
        b5_1.place(x=1000,y=240,width=150,height=35)
     #exit btn
        img9=Image.open(r"college_images\exit.jpg")
